    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (itemIndex) {
            case 0:
                switch (itemClasse) {
                    case 0:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_1A.php";
                        break;
                    case 1:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_1B.php";
                        break;
            ...
            case 1:
                switch (itemClasse) {
                    case 0:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_2A.php";
                        break;
                    case 1:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_2B.php";
                        break;
            ...
            case 2:
                switch (itemClasse) {
                    case 0:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_3A.php";
                        break;
                    case 1:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_3B.php";
                        break;
            ...
            case 3:
                switch (itemClasse) {
                    case 0:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_4A.php";
                        break;
                    case 1:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_4B.php";
                        break;
            ...
            case 4:
                switch (itemClasse) {
                    case 0:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_5A.php";
                        break;
                    case 1:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_5B.php";
                        break;
            ...
            case 5:
                switch (itemClasse) {
                    case 0:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_6A.php";
                        break;
                    case 1:
                        phpFile = "http://192.168.77.192/user/studentlist/student_list_6B.php";
                        break;
