    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (IndexClasse) {
            case 0:
                switch (IndexSeance) {
                    case 0:
                        phpFile = "http://192.168.1.103/user/admin/1A/1AS1.php";
                        break;
                    case 1:
                        phpFile = "http://192.168.1.103/user/admin/1A/1AS2.php";
                        break;
                    case 2:
                        phpFile = "http://192.168.1.103/user/admin/1A/1AS3.php";
                        break;
                    case 3:
                        phpFile = "http://192.168.1.103/user/admin/1A/1AS4.php";
                        break;
                    case 4:
                        phpFile = "http://192.168.1.103/user/admin/1A/1AS5.php";
                        break;
                    case 5:
                        phpFile = "http://192.168.1.103/user/admin/1A/1AS6.php";
                        break;
                    default:
