...
public class class_planning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (itemIndex) {
            case 0:
                phpFile = "http://192.168.77.192/user/classes/premier.php";
                break;
            case 1:
                phpFile = "http://192.168.77.192/user/classes/deuxieme.php";
                break;
            case 2:
                phpFile = "http://192.168.77.192/user/classes/troisieme.php";
                break;
            case 3:
                phpFile = "http://192.168.77.192/user/classes/quatrieme.php";
                break;
            case 4:
                phpFile = "http://192.168.77.192/user/classes/cinquieme.php";
                break;
            case 5:
                phpFile = "http://192.168.77.192/user/classes/sixieme.php";
                break;
            default:
